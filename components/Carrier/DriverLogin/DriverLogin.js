    ...
    await Apis.login(data)
      .then(async res => {
        ...
        if (res.status == true) {
          ...
          if (res.seller_details.length > 0) {
                    ...
                    <TouchableOpacity
                      ...
                      <View style={{ width: '100%', color: '#2a2a2a', marginTop: 20 }}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('ForgetPassword')}>
                          <Text style={{ fontFamily: 'Roboto-Regular', fontSize: 16, color: '#6d6b6c', alignSelf: 'center' }}>Forgot Password</Text>
                        </TouchableOpacity>
                      </View>
                      ...
                      <View
                        ...
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('CarrierRegistration')}>
                          <View style={{ flexDirection: 'row' }}>
                            ...
                            <Text style={{ marginLeft: 5, fontFamily: 'Roboto-Bold' }}>Sign Up</Text>
                          </View>
                        </TouchableOpacity>
                      </View>
