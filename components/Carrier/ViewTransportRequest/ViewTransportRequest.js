...
export default class ViewTransportRequest extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  async getBookingList(isLoaderVisible) {
    this.page = 0;
    ...
    var url =
      '/getBookingList/carrier_id/' + userid + '/pagination/' + this.page;
  ...
  onBidClick = async item => {
    this.props.navigation.navigate('ViewTransportRequestDetails', {
