...
export default class VendorManageProducts extends Component {
    ...
    render() {
      ...
      <CarrierHeader navProps={this.props.navigation} title={'Profile'} />
          <View style={{backgroundColor:'#059d14', marginTop: 0, marginLeft: 0, marginRight: 0,shadowColor: '#000',shadowOffset: {width: 0, height: 2 },  shadowOpacity: 0.25,shadowRadius: 3.84,  elevation: 10,padding:15,      borderBottomLeftRadius: 25,
        borderBottomRightRadius: 25,  }}>
                ...
                <View style={{width: '100%',color:'#2a2a2a', marginTop: 20,position:'relative'}}>
                    ...
                    <TouchableOpacity style={{position:'absolute',right:25,top:5,width:45,height:45,padding:10,borderColor: '#e0e2e4',
                      ...
                      renderItem={({item, index}) => {
                        ...
                        <View style={{flexWrap:'wrap',paddingLeft:15, paddingRight:15, flex:1, flexDirection:'row', justifyContent:'space-between' }} >
                                  <View style={styles.text_info} >
                                    ...
                                    <Text style={{textAlign:'center',fontFamily: 'Roboto-Light',fontSize: 13,marginTop:0}}>Qty Confirmed
                                  </Text>
                                  </View>
                                  ...
                                  <View style={styles.text_info} >
                                    ...
                                    <Text style={{textAlign:'center',fontFamily: 'Roboto-Light',fontSize: 13,marginTop:0}}>Qty Pending
                                  </Text>
                                  </View>
                                  <View style={styles.text_info_add} >
                                  </View>
                                  <View style={styles.text_info} >
                                    ...
                                    <Text style={{textAlign:'center',fontFamily: 'Roboto-Light',fontSize: 13,marginTop:0}}>Qty Sold
                                  </Text>
                                  </View>
